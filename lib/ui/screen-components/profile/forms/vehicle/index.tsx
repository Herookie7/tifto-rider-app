    ...
    try {
      ...
      if (!result.canceled) {
        ...
        if (data?.uploadImageToS3?.imageUrl) {
          ...
          setFormData((prev) => ({ ...prev, vehicleImage: data.uploadImageToS3.imageUrl }));
        } else {
          ...
          <View className="flex flex-col justify-between w-full p-2 h-[90%] mt-0 ">
            ...
            <View>
              <View className="flex flex-col w-full my-2">
                ...
                <TextInput
                  ...
                  onChangeText={(licenseNo) =>
                    handleInputChange("vehicleNumber", licenseNo)
                  }
                  style={{
              ...
              <View className="flex flex-col w-full my-2">
                ...
                {!uploadedImageUrl || !formData.vehicleImage ? (
                  <TouchableOpacity
                  ...
                  <View className="flex flex-row justify-between border  rounded-md p-4 my-2">
                    ...
                    <View className="flex flex-row">
                      <Link
                        download={uploadedImageUrl ?? formData.vehicleImage}
                        href={uploadedImageUrl ?? formData.vehicleImage}
